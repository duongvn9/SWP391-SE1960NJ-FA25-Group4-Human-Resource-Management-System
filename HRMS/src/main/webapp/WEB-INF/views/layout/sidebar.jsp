...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav nav flex-column">
        ...
        <c:if test="${sessionScope.role eq 'Trưởng phòng'}">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/recruitment-request/form">
                    <i class="bi bi-person-plus"></i> Yêu cầu tuyển dụng
                </a>
            </li>
        </c:if>

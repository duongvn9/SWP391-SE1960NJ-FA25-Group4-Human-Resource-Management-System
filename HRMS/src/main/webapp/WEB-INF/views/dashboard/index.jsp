    ...
    <body>
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-nav nav flex-column">
                ...
                <!-- Chỉ Trưởng phòng mới thấy -->
                <c:if test="${sessionScope.userRole eq 'MANAGER'}">
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/recruitment-request/form" class="nav-link" data-tooltip="Yêu cầu tuyển dụng">
                            <i class="bi bi-person-plus"></i>
                            <span>Yêu cầu tuyển dụng</span>
                        </a>
                    </li>
                </c:if>
                    <!-- Trưởng phòng và HR đều thấy -->
<c:if test="${sessionScope.userRole eq 'MANAGER' || sessionScope.userRole eq 'HR'}">
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/job-posting/create" 
           class="nav-link" data-tooltip="Đăng tin tuyển dụng">
        ...
        <div class="main-content" id="main-content">
            ...
            <footer class="dashboard-footer">
                ...
                <p style="color:red;">DEBUG ROLE (session): ${sessionScope.userRole}</p>
                <p style="color:blue;">DEBUG ROLE (attribute): ${debugRole}</p>
                <p>userRole: '${sessionScope.userRole}'</p>
                <c:if test="${sessionScope.userRole eq 'MANAGER'}">
                    <p>Menu dành cho MANAGER hiển thị</p>
                </c:if>
            </footer>
        </div>
